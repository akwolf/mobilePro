...
public class TestAES {
    ...
    public static String decrypt(String content, String password) {
        try {
            ...
            IvParameterSpec zeroIv = new IvParameterSpec(password.getBytes());
            SecretKeySpec key1 = new SecretKeySpec(password.getBytes("utf-8"), "AES");
            Cipher cipher = Cipher.getInstance(transformation);
    ...
    public static void main(String args[]) throws Exception{
        System.out.println(encrypt("哈哈","0123456789123456"));
        System.out.println(decrypt(encrypt("哈哈","0123456789123456"),"0123456789123456"));
    }
}